...
@allure.story('Проверка добавление товара в корзину')
...
# @allure.story('Переход в корзину из всплывающего окна')
# def test_open_cart_with_modal_window(fiory_feed):
#     base_page.open_browser()
#     base_page.find_item(fiory_feed["brand"], fiory_feed["description"])
#     base_page.add_item_cart()
#     cart_page.open_cart_with_modal_window(fiory_feed["description"])
#     cart_page.clean_cart()
